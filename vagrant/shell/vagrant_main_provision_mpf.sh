...
then
    ...
    sudo mkdir -p /root/.ansible/roles/
...
# Execute Ansible
echo "-> Execute Ansible MPF"
ansible-playbook /ansible/playbook_development_mpf.yml -i /ansible/inventories/hosts --connection=local
